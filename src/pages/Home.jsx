...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const updateScreenSize = () => {
      setIsMobile(window.innerWidth <= 768); // Adjust the width based on your breakpoints
    };
  ...
  return (
    <>
      ...
      >
        ...
        {isMobile ? (
          <div className="container my-4 mx-auto row featurette">
            <div className="col-md-7 order-md-1 d-flex flex-column justify-content-center align-items-center">
              ...
              <p className="lead fs-4">
                Discover the perfect balance between nutrition and indulgence.
                Our expertly crafted recipes bring together fresh, vibrant
                ingredients with bold, unforgettable flavors, proving that
                healthy living can be as delicious as it is rewarding.
              </p>
            </div>
          ...
          <motion.div
            className="container my-4 mx-auto row featurette"
        ...
        >
          <div className="col-md-7 order-md-1 d-flex flex-column justify-content-center align-items-center">
            ...
            <p className="lead fs-4">
              ...
              with bold, unforgettable flavors, proving that healthy living can
              be as delicious as it is rewarding.
            </p>
          </div>
